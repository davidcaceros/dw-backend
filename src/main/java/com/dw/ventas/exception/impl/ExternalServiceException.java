...
public class ExternalServiceException extends AbstractServiceException {
    private static final String CODE = "025-1800";

    private ExternalServiceException(final String exceptionMessage,
    ...
    public static class Builder {
        ...
        public ExternalServiceException build() {
            return new ExternalServiceException(exceptionMessage, cause, additionalInformation, errorMessagePropertyKey, errorMessagePropertyArgs);
        }
    }
}