...
public class ResourceNotFoundPdfException extends AbstractServiceException {
    private static final String CODE = "025-0300";

    private ResourceNotFoundPdfException(final String message,
    ...
    public static class Builder {
        ...
        public ResourceNotFoundPdfException build() {
            return new ResourceNotFoundPdfException(message, cause, additionalInformation, errorMessageKey, errorMessageArgs);
        }
    }
}
